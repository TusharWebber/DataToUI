Overview <br>
DataToUI is a WPF-based desktop application developed using C# and .NET for real-time communication with Battery Management Systems (BMS) and CAN diagnostic tools via Serial (COM) ports. <br>
...
Tech Stack Language: C# Framework: .NET WPF Communication: Serial Port (UART / CAN Tool Interface) Architecture: Event-Driven UI + Dispatcher Thread Handling
